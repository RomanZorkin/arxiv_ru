...
[2603.18620] дата публикации в arXiv - 03.2026  
📅 дата перевода 06.07.2026  
🏷 `Reinforcement Learning` `Large Language Models` `Test-time Adaptation` `Prompt Optimization` `Self-improvement` `Tree Search` `Agentic Systems`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2603.18620/2603.18620_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2603.18620)
- [🧠 Summary / README](articles/2603.18620/README.md)
- [⚙ Metadata](articles/2603.18620/metadata.json)

---

### Об эффективном масштабировании GNN через реализации слоев с учетом ввода и вывода
[2605.31500] дата публикации в arXiv - 05.2026  
📅 дата перевода 06.07.2026  
🏷 `GNN` `GPU kernels` `IO-aware` `Sparse attention` `Block-sparse` `Memory reduction` `Graph reordering`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2605.31500/2605.31500_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2605.31500)
- [🧠 Summary / README](articles/2605.31500/README.md)
- [⚙ Metadata](articles/2605.31500/metadata.json)

---

### Насколько хороши линейные модели для прогнозирования временных рядов?
[2606.27282] дата публикации в arXiv - 06.2026  
📅 дата перевода 06.07.2026  
🏷 `time-series forecasting` `linear models` `ridge regression` `hyperparameter tuning` `preprocessing` `lookback optimization` `local normalization`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2606.27282/2606.27282_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2606.27282)
- [🧠 Summary / README](articles/2606.27282/README.md)
- [⚙ Metadata](articles/2606.27282/metadata.json)
