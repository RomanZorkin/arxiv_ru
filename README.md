...
[2501.17834] дата публикации в arXiv - 01.2025  
📅 дата перевода 24.08.2026  
🏷 `Machine Learning` `Robustness` `Fault Tolerance` `Financial Systems` `Online Inference` `System Architecture` `Open Banking`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2501.17834/2501.17834_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2501.17834)
- [🧠 Summary / README](articles/2501.17834/README.md)
- [⚙ Metadata](articles/2501.17834/metadata.json)

---

### Развитие методов глубокого обучения в обнаружении финансовых мошенничеств: систематический обзор литературы
[2502.00201] дата публикации в arXiv - 02.2025  
📅 дата перевода 24.08.2026  
🏷 `Financial Fraud Detection` `Deep Learning` `Systematic Literature Review` `Anomaly Detection` `Imbalanced Data` `Privacy Preserving` `Financial Technology`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2502.00201/2502.00201_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2502.00201)
- [🧠 Summary / README](articles/2502.00201/README.md)
- [⚙ Metadata](articles/2502.00201/metadata.json)

---

### Языковое моделирование для будущего финансов: количественный обзор метрик, задач и возможностей данных
[2504.07274] дата публикации в arXiv - 04.2025  
📅 дата перевода 24.08.2026  
🏷 `Natural Language Processing` `Financial Technology` `Large Language Models` `Quantitative Survey` `Financial Forecasting` `Model Evaluation` `Data Analysis`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2504.07274/2504.07274_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2504.07274)
- [🧠 Summary / README](articles/2504.07274/README.md)
- [⚙ Metadata](articles/2504.07274/metadata.json)

---

### Интерпретируемые большие языковые модели для оценки кредитных рисков: систематический обзор и таксономия
[2506.04290] дата публикации в arXiv - 06.2025  
📅 дата перевода 24.08.2026  
🏷 `Credit Risk Assessment` `Large Language Models` `Explainable AI` `Financial NLP` `Systematic Review` `Model Taxonomy` `Financial Technology`
...
- [📖 Русская HTML версия](https://romanzorkin.github.io/arxiv_ru/articles/2506.04290/2506.04290_ru.html)
- [📄 Оригинальная статья](https://arxiv.org/abs/2506.04290)
- [🧠 Summary / README](articles/2506.04290/README.md)
- [⚙ Metadata](articles/2506.04290/metadata.json)
...
|---|---|---|---|---|
| [2501.17834](articles/2501.17834/README.md) | 01.2025 | 24.08.2026 | Иерархическая архитектура резервного копирования для высокорискового онлайн-вывода моделей машинного обучения (`Hierarchical Fallback Architecture for High Risk Online Machine Learning Inference`) ||
| [2502.00201](articles/2502.00201/README.md) | 02.2025 | 24.08.2026 | Развитие методов глубокого обучения в обнаружении финансовых мошенничеств: систематический обзор литературы (`Year-over-Year Developments in Financial Fraud Detection via Deep Learning: A Systematic Literature Review`) ||
| [2504.07274](articles/2504.07274/README.md) | 04.2025 | 24.08.2026 | Языковое моделирование для будущего финансов: количественный обзор метрик, задач и возможностей данных (`Language Modeling for the Future of Finance: A Quantitative Survey into Metrics, Tasks, and Data Opportunities`) ||
| [2506.04290](articles/2506.04290/README.md) | 06.2025 | 24.08.2026 | Интерпретируемые большие языковые модели для оценки кредитных рисков: систематический обзор и таксономия (`Interpretable LLMs for Credit Risk: A Systematic Review and Taxonomy`) ||
