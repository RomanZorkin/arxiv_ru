...
В каталоге статьи находиться файл article_rag.json - это структурированное AI/RAG представление статьи. При изучении статьи я прикрепляю этот файл к чату (ChatGPT, DeepSeek,...) объясняю, что это контекст нащей беседы и по мере возникновения вопросов прошу его мне просто их объяснить. Результат - просто ПУШКА. Ниже приведен скрин беседы:
<p align="center">
  <img src="assets/arxiv_rag.png" width="80%">
</p>

В ллм был загружен только json файл статьи [RoSHAP](https://arxiv.org/html/2605.15154) (сейчас в работе). И был задан вопрос вырванный из контекста. Обратите внимание насколько подробно с приведением формул был получен ответ.
